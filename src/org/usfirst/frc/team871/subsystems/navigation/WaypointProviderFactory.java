...
import org.usfirst.frc.team871.subsystems.navigation.actions.ImmediateSetGrabberAction;
...
//        };
        ...
        Waypoint lSwitchMiddle = new Waypoint(174, 55, 0, 0);
        Waypoint lSwitchMiddleInner = new Waypoint(174, 90 + 10, 0, 0);
        Waypoint rSwitchMiddle = new Waypoint(174, 270, 0, 0);
        Waypoint rSwitchMiddleInner = new Waypoint(174, 270 - 38, 0, 0);
        ...
        Waypoint lScaleInner = new Waypoint(312, 34 + 34, 0, 0);
        Waypoint rScale = new Waypoint(312, 290, 0, 0);
        Waypoint rScaleInner = new Waypoint(312, 290 - 34, 0, 0);
        Waypoint rScaleClose = new Waypoint(316 - 36, 236, 0, 0); //230 252
        Waypoint rScaleCloseInner = new Waypoint(316 - 12, 236, 0, 0);
        Waypoint lScaleClose = new Waypoint(320 - 36, 80, 0, 0); //230 252
        Waypoint lScaleCloseInner = new Waypoint(320 - 12, 80, 0, 0);
...
//        addPath("WoodshopDrop", new WaypointArrayPositionWrapper(pts, null, null, null));
        ...
        addPath("LSwitch", new WaypointArrayPositionWrapper(new Waypoint[]{
        	new Waypoint(40, 64, 0, 0.4, null),
        	new Waypoint(lSwitchMiddle, 0.7, new LiftSetpointAction(lift, SetpointHeights.LOW_SWITCH, true)),
        	new Waypoint(lSwitchMiddleInner, 0.7, new ImmediateSetGrabberAction(grabber, false, 500)),
...
//        	new Waypoint(12 * 20, 212, 0, -0.3, new LiftSetpointAction(lift, SetpointHeights.GROUND))
        ...
        addPath("RSwitch", new WaypointArrayPositionWrapper(new Waypoint[]{ // y=262
        		new Waypoint(40, 260, 0, 0.4, null),
        		new Waypoint(rSwitchMiddle, 0.7, new LiftSetpointAction(lift, SetpointHeights.LOW_SWITCH, true)),
            	new Waypoint(rSwitchMiddleInner, 0.7, new ImmediateSetGrabberAction(grabber, false, 500)),
...
//        }, WaypointPosition.START_R, WaypointPosition.SWITCH_R, null));
        ...
        addPath("RScale", new WaypointArrayPositionWrapper(new Waypoint[]{ //y=287
    			...
    			new Waypoint(316, 324 - 40, 0, 0.3, new LiftSetpointAction(lift, SetpointHeights.SCALE_HIGH, true)),
        ...
        addPath("LStartRScale", new WaypointArrayPositionWrapper(new Waypoint[]{
        		new Waypoint(lCenterLine, 0.6, new LiftSetpointAction(lift, SetpointHeights.LOW_SWITCH)),
//        		new Waypoint(rCenterLine, 0.6, null),
        ...
        addPath("RStartLScale", new WaypointArrayPositionWrapper(new Waypoint[]{
        		new Waypoint(40, 260, 0, 0.4, null),
        		new Waypoint(rCenterLine, 0.6, new LiftSetpointAction(lift, SetpointHeights.LOW_SWITCH)),
        ...
        addPath("MStartLSwitch", new WaypointArrayPositionWrapper(new Waypoint[]{
                ...
                new Waypoint(120 + 24, 107, 0, 0.7, new ImmediateSetGrabberAction(grabber, false, 500))
        ...
        addPath("MStartRSwitch", new WaypointArrayPositionWrapper(new Waypoint[]{
                ...
                new Waypoint(120 + 24, 210, 0, 0.7, new ImmediateSetGrabberAction(grabber, false, 500))
        ...
        addPath("MStartLScale", new WaypointArrayPositionWrapper(new Waypoint[]{
        		new Waypoint(40, 160, 0, 0.4, null),
